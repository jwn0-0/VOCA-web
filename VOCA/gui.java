 ...
 * @throws InterruptedException 
   ...
   public static void wow() throws IOException, InterruptedException {
      ...
      frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         ...
         textField.setEditable(false); //추가
         ...
         okbutton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
               ...
               che++;
                textField.setText(vocabu.han[vocabu.randnum[che]]);
              System.out.println("che : "+che);
              System.out.println(answer1);
                 answer1=answerField.getText();
                press=1;
                 System.out.println("adfdadfad");
                 answere=vocabu.eng[vocabu.randnum[che-1]];
                 answerh=vocabu.han[vocabu.randnum[che-1]];
                 
                 if(answer1.equals(vocabu.eng[vocabu.randnum[che-1]]))
                 {
         ...
         label.setIcon(new ImageIcon("img/WWok1.png"));
